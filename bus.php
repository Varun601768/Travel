...
<html lang="en">
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="trains col-sm-12" style="background: url(../travel/images/bus/bus10_bg.jpg); background-position:center">
					...
					<div class="search">
    					...
    					<form action="busSearch.php" method="POST">
    						...
    						<div class="col-sm-6">			
   							<div class="form-group">
   								 <label for="originTrain">Origin:<p> </p></label>
      								...
      								<select id= "originTrain"  data-live-search="true" class="selectpicker form-control" data-size="6" title="Select Origin Station" name="origin" required>
       									<option value="Bangalore" data-subtext="BAN" data-tokens="BAN Bangalore">Bangalore</option>
        								<option value="Mangalore" data-subtext="MAN" data-tokens="MAN Mangalore">Mangalore</option>
       									<option value="Pune" data-subtext="PUN" data-tokens="PUN Pune">Pune</option>
        								<option value="Delhi" data-subtext="DEL" data-tokens="DEL Delhi">Delhi</option>
        								<option value="Coimbatore" data-subtext="COI" data-tokens="COI Coimbatore">Coimbatore</option>
										<option value="Tirupati" data-subtext="TIR" data-tokens="TIR Tirupati">Tirupati</option>
      								</select>
							</div>
            			</div>
            				...
            				<div class="col-sm-6">			
   							<div class="form-group">
   								 <label for="destinationTrain">Destination:<p> </p></label>
      								...
      								<select id= "destinationTrain"  data-live-search="true" class="selectpicker form-control" data-size="6" title="Select Destination Station" name="destination" required>
									   <option value="Bangalore" data-subtext="BAN" data-tokens="BAN Bangalore">Bangalore</option>
        								<option value="Mangalore" data-subtext="MAN" data-tokens="MAN Mangalore">Mangalore</option>
       									<option value="Pune" data-subtext="PUN" data-tokens="PUN Pune">Pune</option>
        								<option value="Delhi" data-subtext="DEL" data-tokens="DEL Delhi">Delhi</option>
							...
							<label for="class">Select Class: <p> </p></label>
    							<div class="form-group">
    								<select id= "class" class="selectpicker form-control" data-size="5" title="Select Class" name="class" required>
  										<option value="1AC">Non AC Seater</option>
  										<option value="2AC">AC Seater</option>
  										<option value="3AC">Non AC Sleeper</option>
  										<option value="SL"> AC Sleeper</option>
									</select>
								</div>
							</div>
            				...
            				<div class="col-sm-12 text-center">
            					...
            					<input type="submit" class="button" name="searchbus" value="Search Bus">
