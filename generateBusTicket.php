	...
	<body>
		...
		<?php
			...
			if($mode=="bus"){
				...
				$getSeatsAvailableOutboundSQL = "SELECT $seatsClass FROM `bus` WHERE busID='$busID'";
				...
				$outboundSeatUpdateSQL = "UPDATE `bus` SET $seatsClass='$newseatsAvailable' WHERE busID='$busID'";
