...
<html lang="en">
	...
	<body>
		...
		<?php
			...
			$seatsClass = trim('seatsAvailable');  //.$class
			$priceClass = trim('fare');
		...
		<?php
			...
			$sql = "SELECT * FROM bus WHERE origin='$origin' AND destination='$destination' ";  //AND runsOn LIKE '%$trimDay%'
			...
			<form action="booking.php" method="POST">
				...
				<div class="col-sm-2 text-center">
					...
					<div class="arrivesSubscript">
						...
						Platform #<?php echo $row["departure"]; ?>
				...
				$getSeatsAvailableSQL = "SELECT $seatsClass FROM `bus` WHERE busID='$busID'";
				...
				<input type="hidden" name="priceHidden" value="<?php echo $priceClass; ?>">
