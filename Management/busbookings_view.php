...
if (isset($_POST['search'])) {
    $info = getData();
    $search_query = "SELECT * FROM busbookings WHERE bookingID = '$info[0]'";
...
<body>
    ...
    <div class="col-lg-8">
        <h1 class="text-danger text-center" style="font-weight:bold">Bus Booking Details</h1>
        <br>
        <br>
        <?php
        $servername = "localhost";
        ...
        $sql = "SELECT bookingID,username,date,cancelled,origin,destination,passengers FROM busbookings";
