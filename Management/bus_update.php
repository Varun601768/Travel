...
if (isset($_POST['update'])) {
    $info = getData();
    $update_query = "UPDATE `bus` SET operator='$info[1]',type='$info[2]',origin='$info[3]',destination='$info[4]',originArea='$info[5]',destinationArea='$info[6]',departure='$info[7]',arrival='$info[8]',seats='$info[9]',windows='$info[10]',fare='$info[11]',seatsAvailable='$info[12]',noOfBookings='$info[13]' WHERE busID = '$info[0]'";
    try {
  ...
  justify-content: center;">
			<div class="col-lg-4">
				...
				<form method="post" action="">
					...
					<input type="number" name="busID" class="form-control" placeholder="Bus ID /Automatic Number Genrates" value="<?php echo ($busID); ?>" required>
					...
					<div class="form-group row">
						...
						<div class="col-xs-6">
							<h4>Bus Type</h4>
							<input type="text" name="type" class="form-control" placeholder="Enter bus type" value="<?php echo ($type); ?>">
						</div>
						...
						<div class="col-xs-6">
							<h4>Origin Area</h4>
							<input type="text" class="form-control" name="originArea" placeholder="Enter origin area" value="<?php echo ($originArea); ?>">
						</div>


						<div class="col-xs-6">
							<h4>Destination Area</h4>
							<input type="text" name="destinationArea" class="form-control" placeholder="Enter destination Area" value="<?php echo ($destinationArea); ?>">
						</div>

						<div class="col-xs-6">
							<h4>Departure</h4>
							<input type="time" name="departure" class="form-control" placeholder="Enter departure time" value="<?php echo ($departure); ?>">
						</div>

						<div class="col-xs-6">
							<h4>Arrival</h4>
							<input type="time" name="arrival" class="form-control" placeholder="Enter arrival time" value="<?php echo ($arrival); ?>">
						</div>

						<div class="col-xs-6">
							<h4>Seats</h4>
							<input type="number" name="seats" class="form-control" placeholder="Enter no.of seats" value="<?php echo ($seats); ?>">
						</div>

						<div class="col-xs-6">
							<h4>Windows</h4>
							<input type="number" name="windows" class="form-control" placeholder="Enter no. of windows" value="<?php echo ($windows); ?>">
						</div>
						...
						<div class="col-xs-6">
							...
							<input type="number" name="seatsAvailable" class="form-control" placeholder="Enter no.of seats available" value="<?php echo ($seatsAvailable); ?>">
						</div>

                        <div class="col-xs-6">
							<h4>No. Of Bookings</h4>
							<input type="number" name="noOfBookings" class="form-control" placeholder="Enter no.of bookings" value="<?php echo ($noOfBookings); ?>">
						</div>
        ...
        <div class="col-lg-8">
            <h1 class="text-danger text-center" style="font-weight:bold">Bus Data Update | Delete </h1>
            <?php
            $servername = "localhost";
            $username = "root";
            $password = "";
