...
<html lang="en">
  ...
  <body >
          ...
          <h1>Admin Panel</h1>
             ...
             <div class="options">
              <center>
              <h3><a href="system_info/index.html">Write About Us</a></h3>
    ...
    <center>
    <button class="btn btn-secondary"> <a href="http://localhost/travel/travel/index.php"><h5>Click here to go to user panel</h5></a></button>
    </center>   
  </body>
</html>
